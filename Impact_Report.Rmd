...
impact_figure(tabular_data[1])[[1]]
```
**Legend**  `r impact_figure(tabular_data[1])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[2])[[1]]
```
**Legend**  `r impact_figure(tabular_data[2])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[3])[[1]]
```
**Legend**  `r impact_figure(tabular_data[3])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[4])[[1]]
```
**Legend**  `r impact_figure(tabular_data[4])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[6])[[1]]
```
**Legend**  `r impact_figure(tabular_data[6])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[7])[[1]]
```
**Legend**  `r impact_figure(tabular_data[7])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[8])[[1]]
```
**Legend**  `r impact_figure(tabular_data[8])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[9])[[1]]
```
**Legend**  `r impact_figure(tabular_data[9])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[10])[[1]]
```
**Legend**  `r impact_figure(tabular_data[10])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[11])[[1]]
```
**Legend**  `r impact_figure(tabular_data[11])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[12])[[1]]
```
**Legend**  `r impact_figure(tabular_data[12])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[13])[[1]]
```
**Legend**  `r impact_figure(tabular_data[13])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[14])[[1]]
```
**Legend**  `r impact_figure(tabular_data[14])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[15])[[1]]
```
**Legend**  `r impact_figure(tabular_data[15])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[16])[[1]]
```
**Legend**  `r impact_figure(tabular_data[16])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[17])[[1]]
```
**Legend**  `r impact_figure(tabular_data[17])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[18])[[1]]
```
**Legend**  `r impact_figure(tabular_data[18])[[2]]`

```{r results="asis", echo = FALSE}
impact_figure(tabular_data[19])[[1]]
```
**Legend**  `r impact_figure(tabular_data[19])[[2]]`
